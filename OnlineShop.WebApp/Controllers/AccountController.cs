        ...
        public async Task<IActionResult> CreateRolesOnce()
        {
            ...
            if (!x)
            {
                ...
                if (chkUser.Succeeded)
                {
                    ...
                    await userMgr.AddToRoleAsync(korisnik1, "Korisnik");
                    await userMgr.AddToRoleAsync(korisnik2, "Korisnik");
                    await userMgr.AddToRoleAsync(korisnik3, "Korisnik");
                }
            }
